...
<div id="page" class="site">
	...
	<div class="logo-loading">
		...
		viewBox="0 0 148 142" style="enable-background:new 0 0 148 142;" xml:space="preserve">
			<title>Marconte</title>
			<defs>
				<linearGradient id="grad3" gradientUnits="userSpaceOnUse" x1="0%" y1="0%" x2="100%" y2="0%">
				<stop offset="0%" style="stop-color:#43E695;stop-opacity:1" />
				<stop offset="100%" style="stop-color:#3BB2B8;stop-opacity:1" />
				</linearGradient>
			</defs>
			<polygon class="st0" fill="url(#grad3)" points="56.6,21 19,84.3 56.6,84.3 74.9,53.4 "/>
			<polygon class="st0" fill="url(#grad3)" points="94.2,21 74.9,53.4 92.4,84.3 130,84.3 "/>
			<rect class="st2" fill="url(#grad3)" x="36.9" y="120.3" class="st2" width="70.6" height="1"/>
			<line class="st1" x1="36.9" y1="120.8" x2="107.5" y2="120.8"/>
		</svg>
	</div>
