...
// Project related.
var project                 = 'marconte'; // Project Name.
var projectURL              = 'marconte.local'; // Local project URL of your already running WordPress site. Could be something like local.dev or localhost:8888.
var productURL              = './'; // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.

// Translation related.
var text_domain             = 'marconte'; // Your textdomain here.
var translationFile         = 'marconte.pot'; // Name of the transalation file.
var translationDestination  = './languages'; // Where to save the translation files.
var packageName             = 'marconte'; // Package name.
...
var imagesDestination       = './img/opt'; // Destination folder of optimized images. Must be different from the imagesSRC folder.
...
gulp.task('build-copy', function() {
  return gulp.src(build_files)
    .pipe(gulp.dest('dist/marconte'));
});

gulp.task('build-zip', function() {
  return gulp.src('dist/**/*')
    .pipe(zip('marconte.zip'))
    .pipe(gulp.dest('dist'));
});

gulp.task('build-delete', function() {
  del(['dist/**/*', '!dist/marconte.zip']);
});
